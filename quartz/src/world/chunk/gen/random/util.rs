...
pub fn i64_seed_to_u128_seed(long: i64) -> u128 {
    let low = long ^ 7640891576956012809;
    let high = low + -7046029254386353131;


    (mix_stafford_13(high) as u128) << 64 | mix_stafford_13(low) as u128
}
...
pub fn mix_stafford_13(mut long: i64) -> i64 {
    long = (long ^ long >> 30) * -4658895280553007687;
    long = (long ^ long >> 27) * -7723592293110705685;
    long ^ long >> 31
}

/// Returns a positional random seed
pub fn get_pos_seed(x: i32, y: i32, z: i32) -> i64 {
    let temp = (x as i64 * 3129871) ^ (z as i64 * 116129781) ^ y as i64;
    temp * temp * 42317861 + temp * 11
}
