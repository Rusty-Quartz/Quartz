...
pub fn derive_listenable_internal(input: proc_macro::TokenStream) -> proc_macro::TokenStream {
    ...
    proc_macro::TokenStream::from(quote! {
        impl quartz_plugins::Listenable for #name {
            fn run_listeners(self, manager: &quartz_plugins::PluginManager) -> #name {
                match self {
                    #enum_match
                }
            }
...
pub fn run_listeners_enum(enum_name: &Ident, data: &Data) -> TokenStream {
